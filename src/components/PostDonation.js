  ...
  render() {
    ...
    return (
      <div className="post-parent">
        ...
        <h1>Image url</h1>
        <Upload
          uploadDestination={REACT_APP_CLOUDINARY_DONATION}
          handleCloudinary={this.handleCloudinary}
        />
        <div className="button-parent">
          <div
            className={`${this.state.category === 4 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 4 })}
          >
            Home
          </div>
          <div
            className={`${this.state.category === 2 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 2 })}
          >
            Clothing
          </div>
          <div
            className={`${this.state.category === 3 ? "ham" : "dud"}`}
          ...
          <div
            data-testid="ham"
            className={`${this.state.category === 1 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 1 })}
          >
            Furniture
          </div>
          <div
            className={`${this.state.category === 5 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 5 })}
          >
            Education
          </div>
          <div
            className={`${this.state.category === 6 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 6 })}
          >
            Sports & Games
          </div>
          <div
            className={`${this.state.category === 7 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 7 })}
          >
            Movies & Music
          </div>
          <div
            className={`${this.state.category === 8 ? "ham" : "dud"}`}
            onClick={() => this.setState({ category: 8 })}
          >
            Baby & Child
          </div>
          <div
            className={`${this.state.category === 9 ? "ham" : "dud"}`}
